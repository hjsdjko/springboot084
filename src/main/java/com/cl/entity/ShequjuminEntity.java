...
public class ShequjuminEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public ShequjuminEntity() {
		
	}
	
	public ShequjuminEntity(T t) {
		try {
	 ...
	 * 设置：居民密码
	 */
	public void setJuminmima(String juminmima) {
		this.juminmima = juminmima;
	}
	/**
	 * 获取：居民密码
	 */
	public String getJuminmima() {
		return juminmima;
	}
	/**
	 * 设置：居民姓名
